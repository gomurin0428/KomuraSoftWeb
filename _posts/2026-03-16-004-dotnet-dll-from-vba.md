...
tags:
  ...
  - Access
  - Office
description: "VBA から任意の .NET DLL を直接呼ぶことはできません。COM として公開する方法を中心に、.NET Framework 4.8.x と .NET 8 以降の違い、32bit / 64bit、登録、VBA からの呼び出し、ハマりどころまで整理します。"
consultation_services:
  - id: windows-app-development
    reason: "VBA、COM、Office、.NET の接続面をどう設計するかは Windows アプリ開発と強く結び付くので、Windowsアプリ開発 と相性がよいテーマです。"
  - id: technical-consulting
    reason: "既存 VBA 資産と C# ロジックの境界設計、bitness、登録、配布方式まで含めて整理したい場合は、技術相談・設計レビューとして進めやすいです。"
---
...
- `.NET 8` 以降でも COM 公開はできますが、**VBA の早期バインディングに必要な type library 周りが少し重い**です
...
### 6.3 `/codebase` は楽だが、配置を動かすと死にやすい
...
### 6.4 `参照を追加できません` はだいたい COM 入口の問題
