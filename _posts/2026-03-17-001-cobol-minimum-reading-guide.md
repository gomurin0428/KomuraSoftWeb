---
title: "あなたがいきなり COBOL のソースを読む羽目になった時に最低限知っておくべきこと - DIVISION / PIC / COMP-3 / COPY / PERFORM を先に整理"
...
tags:
  ...
  - 保守
  - Mainframe
description: "突然 COBOL のソースを読むことになった人向けに、DIVISION、PIC、COMP-3、COPY、PERFORM、固定形式、外部境界の見方を最小セットで整理します。"
consultation_services:
  - id: technical-consulting
    reason: "既存 COBOL 資産の読み解き方、改修の入り口、外部境界の把握、移行前の見立て整理まで含めて、技術相談・設計レビューと相性がよいテーマです。"
  - id: bug-investigation
    reason: "引き継ぎ直後の障害対応や、COBOL 資産のどこで不整合が起きているかを追う作業は、不具合調査・原因解析として進めやすいです。"
---
