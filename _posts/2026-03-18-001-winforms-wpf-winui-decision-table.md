---
title: "Windows Forms、WPF、WinUI のどれにするか - 新規開発、既存資産、配布、UI 表現の判断表"
...
tags:
  ...
  - Windows開発
  - UI設計
description: "WinForms、WPF、WinUI のどれを選ぶべきかを、新規開発、既存資産、配布、UI 表現、チーム体制の観点から整理します。"
consultation_services:
  - id: windows-app-development
    reason: "WinForms、WPF、WinUI の選定は、Windows デスクトップアプリの新規開発や既存資産の延命方針に直結するテーマです。"
  - id: technical-consulting
    reason: "既存資産、Windows App SDK、配布設計、UI 表現、MVVM 文化まで含めて、どの選択が一番摩擦が少ないかを整理する段階に向いています。"
---
