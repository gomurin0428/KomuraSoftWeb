...
tags:
  ...
  - クラッシュダンプ
  - 不具合調査
description: "Windows アプリが想定外例外やプログラムミスで落ちても、あとから原因を追える証跡を残すために、通常ログ、最終クラッシュマーカー、WER LocalDumps、監視プロセスをどう組み合わせるべきかを整理します。"
consultation_services:
  - id: bug-investigation
    reason: "顧客環境でしか出ないクラッシュ、低再現率の異常終了、ダンプとログの突き合わせによる原因解析は、不具合調査・原因解析と相性がよいテーマです。"
  - id: windows-app-development
    reason: "WPF、WinForms、常駐アプリ、Windows サービスで、通常ログ、WER、watchdog をどう設計するかは Windows アプリ開発そのものに直結します。"
---
