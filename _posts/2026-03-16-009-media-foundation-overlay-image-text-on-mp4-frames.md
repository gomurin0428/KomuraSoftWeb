---
title: "Media Foundation で MP4 動画の各フレームに画像と文字を焼き込む方法 - Source Reader / 描画 / 色変換 / Sink Writer の整理と .cpp にそのまま貼れる 1 ファイル完結版"
...
tags:
  ...
  - DirectWrite
  - H.264
description: "Media Foundation で MP4 動画の各フレームへ画像と文字を焼き込み、新しい MP4 を作る考え方を、Source Reader、描画、色変換、Sink Writer の分担と 1 ファイル完結の C++ サンプルで整理します。"
consultation_services:
  - id: windows-app-development
    reason: "Media Foundation、GDI+、Direct2D / DirectWrite、色変換、動画出力をまたぐ Windows アプリ実装と直結するテーマです。"
  - id: technical-consulting
    reason: "1 ファイル実装から本番向け構成へどう伸ばすか、音声 remux や GPU 化をどこで切り分けるかの設計整理にも向いています。"
---
