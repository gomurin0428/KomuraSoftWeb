...
前編の [産業用カメラ制御アプリが1か月後に突然落ちるとき - ハンドルリークの見つけ方と長期稼働向けログ設計【前編】](./001-handle-leak-industrial-camera-long-run-crash-part1.md) では、長時間運転後に落ちる制御アプリを調べた結果、原因がハンドルリークだった事例を整理しました。
...
前編: [産業用カメラ制御アプリが1か月後に突然落ちるとき - ハンドルリークの見つけ方と長期稼働向けログ設計【前編】](./001-handle-leak-industrial-camera-long-run-crash-part1.md)

## 10. 参考資料

- [前編: 産業用カメラ制御アプリが1か月後に突然落ちるとき - ハンドルリークの見つけ方と長期稼働向けログ設計](./001-handle-leak-industrial-camera-long-run-crash-part1.md)
