...
<div class="topic-hub-intro">
  <p>このページは、KomuraSoft の技術記事を「記事単体」ではなく「テーマのまとまり」で辿れるようにするための入口です。関心が近い記事同士をまとめて見ることで、Google にも読者にも、どのテーマで何を扱っているサイトかが伝わりやすくなります。</p>
  <p>気になる技術キーワードから入って、関連記事と関連サービスをまとめて辿れるようにしています。まず近いトピックから見てください。</p>
</div>
