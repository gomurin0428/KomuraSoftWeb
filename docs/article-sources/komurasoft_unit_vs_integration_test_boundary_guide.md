...
lang: "ja"
slug: "unit-test-vs-integration-test-boundary-guide"
author: "小村 豪"
...
2. [Integration tests in ASP.NET Core](https://learn.microsoft.com/en-us/aspnet/core/test/integration-tests?view=aspnetcore-10.0)
3. [ASP.NET Core での統合テスト](https://learn.microsoft.com/ja-jp/aspnet/core/test/integration-tests?view=aspnetcore-10.0)
4. [Unit test controller logic in ASP.NET Core](https://learn.microsoft.com/en-us/aspnet/core/mvc/controllers/testing?view=aspnetcore-10.0)
5. [ASP.NET Core サービスと Web アプリのテスト](https://learn.microsoft.com/ja-jp/dotnet/architecture/microservices/multi-container-microservice-net-applications/test-aspnet-core-services-web-apps)
6. [The Practical Test Pyramid](https://martinfowler.com/articles/practical-test-pyramid.html)

## 関連トピック

### [技術トピック](https://comcomponent.com/topics/)

KomuraSoft の技術記事と関連サービスを、課題別にたどれる一覧ページです。近いテーマから全体像をつかめます。

### [Application Verifier とは何かと異常系テスト基盤の作り方](https://comcomponent.com/blog/2026/03/11/003-application-verifier-abnormal-test-foundation-part2/)

異常系テストや観測点をどこまで設計へ織り込むべきか、という実務寄りのテーマに近い記事です。

### [共有メモリを使うときの落とし穴とベストプラクティス](https://comcomponent.com/blog/2026/03/18/000-shared-memory-pitfalls-best-practices/)

同期、可視性、寿命、ABI、権限まで含めた「境界で壊れやすいもの」の考え方と相性がよい記事です。

## このテーマの相談先

### [技術相談・設計レビュー](https://comcomponent.com/services/technical-consulting/)

テスト戦略、責務分割、境界設計、既存システム改修時の方針整理から入りたい場合に向いています。

### [不具合調査・原因解析](https://comcomponent.com/services/bug-investigation/)

再現しにくい障害や、結合テストでしか拾えない不具合の切り分け、観測点の設計と相性がよいテーマです。

### [Windowsアプリ開発](https://comcomponent.com/services/windows-app-development/)

Windows デスクトップアプリ、装置連携、長期運用を前提にした設計・実装まで含めて進めたい場合に向いています。
