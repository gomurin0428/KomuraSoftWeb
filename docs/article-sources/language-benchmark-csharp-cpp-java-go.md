...
1. [まず結論](#まず結論)
2. [最初に決めるべきこと](#最初に決めるべきこと)
3. [なぜ言語比較は難しいのか](#なぜ言語比較は難しいのか)
4. [比較でやってはいけないこと](#比較でやってはいけないこと)
5. [C# / C++ / Java / Go を比べるときの基本方針](#c--c-java-go-を比べるときの基本方針)
6. [具体例: どんなベンチ項目を用意するべきか](#具体例-どんなベンチ項目を用意するべきか)
7. [言語ごとに揃えるべき条件](#言語ごとに揃えるべき条件)
8. [実行環境の揃え方](#実行環境の揃え方)
9. [何を測るべきか](#何を測るべきか)
10. [実行手順のおすすめ](#実行手順のおすすめ)
11. [結果の読み方](#結果の読み方)
12. [記録テンプレート](#記録テンプレート)
13. [まとめ](#まとめ)
14. [参考資料](#参考資料)
