---
title: "産業用カメラ制御でまれに数秒止まる TCP 通信をどう詰めたか - 再送待ちと RFC1323 タイムスタンプの話"
...
tags:
  ...
  - Windows開発
  - 産業用カメラ
description: "産業用カメラ制御の TCP 通信で、まれに数秒停止する事象をパケットロス起点の再送待ちとして切り分け、RFC1323 系のタイムスタンプで改善したときの考え方を整理します。"
---
