...
* 依存ライブラリが強く reflection や動的コード生成に依存している
  * AOT publish の warning が出るなら、その warning を雑に無視しないほうがよいです。
...
* [C# からネイティブ DLL を使うなら C++/CLI ラッパーが有力な理由 - KomuraSoft Blog](https://comcomponent.com/blog/2026/03/07/000-cpp-cli-wrapper-for-native-dlls/)
* [32bit アプリから 64bit DLL を呼び出す方法 - COM ブリッジが役立つケーススタディ - KomuraSoft Blog](https://comcomponent.com/blog/2026/01/25/002-com-case-study-32bit-to-64bit/)
