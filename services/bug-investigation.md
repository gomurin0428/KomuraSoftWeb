...
offer_catalog:
  - name: "不具合原因調査"
    description: "再現しにくい不具合、通信停止、クラッシュの切り分けと原因特定"
  - name: "長期稼働障害の解析"
    description: "長時間運転後にだけ発生するリーク、リソース枯渇、停止の解析"
  - name: "再発防止支援"
    description: "ログ設計、観測点追加、異常系テスト基盤整備による再発防止支援"
faq:
  - q: "原因調査だけを依頼することもできますか？"
    a: "はい。改修まで一括でなくても、まず原因調査と切り分けだけを進める形で対応できます。"
  - q: "再現率が低い不具合でも相談できますか？"
    a: "可能です。ログ、メトリクス、パケット、リソース使用量などの観測方法を含めて、再現率の低い不具合の調査を進めます。"
related_articles:
