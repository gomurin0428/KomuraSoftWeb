...
service_keywords:
  ...
  - Inquiry Flow
breadcrumb_parent_label: "Website Development & SEO"
breadcrumb_parent_url: "/en/services/website-development-seo/"
offer_catalog:
  - name: "Homepage redesign"
    description: "Hero copy, structure, and calls to action that explain the business clearly"
  - name: "Service-page design"
    description: "Service pages that make the audience, offer, and next step clear"
  - name: "Inquiry-flow review"
    description: "Contact pages, calls to action, and form fields redesigned for better inquiry flow"
faq:
  - q: "Can we start with only the homepage?"
    a: "Yes. The homepage, contact page, and one important service page are often enough to start."
...
- company and profile page rework
