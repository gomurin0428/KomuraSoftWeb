...
<div class="topic-hub-intro">
  <p>This page is meant to let people move through KomuraSoft's articles by technical theme instead of finding each article one by one. Grouping related articles together makes it easier for both readers and search engines to understand what kind of technical territory this site covers.</p>
  <p>Start from the topic closest to your situation, then follow the related articles and service pages from there.</p>
</div>
