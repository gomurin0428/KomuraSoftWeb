---
title: "産業用カメラ制御アプリが1か月後に突然落ちるとき - ハンドルリークの見つけ方と長期稼働向けログ設計【前編】"
...
後編では、[Application Verifier とは何か - メモリ不足やハンドル異常を前倒しで表面化させる異常系テストの実践【後編】](./002-application-verifier-abnormal-test-foundation-part2.md) として、異常系テスト基盤の話をします。
...
後編: [Application Verifier とは何か - メモリ不足やハンドル異常を前倒しで表面化させる異常系テストの実践【後編】](./002-application-verifier-abnormal-test-foundation-part2.md)
...
- [後編: Application Verifier とは何か - メモリ不足やハンドル異常を前倒しで表面化させる異常系テストの実践](./002-application-verifier-abnormal-test-foundation-part2.md)
