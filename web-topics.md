...
related_pages:
  ...
  - title: "SEO対策・Google広告運用・問い合わせ導線改善"
...
<div class="topic-hub-grid">
  ...
  <section class="topic-hub-card">
    ...
    <div class="topic-hub-links">
      <a class="topic-hub-link" href="/services/seo-lead-optimization/">SEO対策・Google広告運用・問い合わせ導線改善</a>
      <a class="topic-hub-link" href="/blog/2026/03/25/001-inquiry-flow-fix-first-three-places/">問い合わせが来ないサイトで、先に直すべき3つの場所</a>
    </div>
  </section>
  <section class="topic-hub-card">
    <h3>Google広告運用</h3>
    <p>検索広告を出すだけでなく、検索語句、広告文、LP、計測を一体で見直すための入口です。</p>
    <div class="topic-hub-links">
      <a class="topic-hub-link" href="/services/seo-lead-optimization/">SEO対策・Google広告運用・問い合わせ導線改善</a>
      <a class="topic-hub-link" href="/blog/2026/03/24/000-seo-google-ads-best-practices/">SEO対策とGoogle広告のベストプラクティス - 一般論でつかむ検索集客の設計図</a>
    </div>
  </section>
  <section class="topic-hub-card">
    <h3>問い合わせ導線改善</h3>
